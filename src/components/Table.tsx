  ...
  return (
    <div data-module="idsk-table" id="priklad-2">
      ...
      <div
        ...
        className="idsk-table-filter "
      >
        <div className="idsk-table-filter__panel idsk-table-filter__inputs">
          <div className="idsk-table-filter__title govuk-heading-m">
            Filtrovať obsah
          </div>
          <button
        ...
        >
          <div className="govuk-body idsk-table-filter__title">
            Aktívny filter
          </div>
          <button
            className="govuk-body govuk-link idsk-filter-menu__toggle"
          ...
          <div className="govuk-clearfix idsk-table-filter__content"></div>
        </div>
      </div>
      ...
      <table className="idsk-table">
        <thead className="idsk-table__head">
          <tr className="idsk-table__row">
            ...
            <th
              scope="col"
              className="idsk-table__header idsk-table__header--numeric"
            >
              <span className="th-span">
                Rozloha
                <button className="arrowBtn">
        ...
        <tbody className="idsk-table__body" style={{ maxHeight: "364px" }}>
          <tr className="idsk-table__row">
            ...
            <td className="idsk-table__cell">Bratislava</td>
            <td className="idsk-table__cell idsk-table__cell--numeric">
              367,66
            </td>
            <td className="idsk-table__cell idsk-table__cell--numeric">
              1 199,34
      ...
      <div className="idsk-table__meta">
        <div className="idsk-button-group idsk-table__meta-buttons"></div>
