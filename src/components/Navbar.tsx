                      ...
                      <div className="govuk-grid-row">
                        <div className="govuk-grid-column-one-half">
                          ...
                          <p className="govuk-body-s">
                            Toto je oficiálna webová stránka orgánu verejnej
                            moci Slovenskej republiky. Oficiálne stránky
                        ...
                        <div className="govuk-grid-column-one-half">
                          ...
                          <p className="govuk-body-s">
                            ...
                            verejnej správy SR. Zabezpečená stránka vždy začína
                            https:// pred názvom domény webového sídla.
                          </p>
                        </div>
                      </div>
                    </div>
          ...
          <div className="govuk-width-container">
            <div className="govuk-grid-row">
              ...
              <div className="govuk-grid-column-full">
                <nav className="">
                  <ul
                    className="idsk-header-web__nav-list "
