...
export const EkoCreateView = ({ data, mutate, editData }: IEkoCreateView) => {
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
            <>
                ...
                <div>
                    <div>
                        {editData ? (
                            <h2 className="govuk-heading-l">{t('eko.editCode')}</h2>
                        ) : (
                            <h2 className="govuk-heading-l">{t('eko.createdCode')}</h2>
                        )}
                    </div>
                    {editData && (
