...
export const generateCreateOrganizationSchema = (t: TFunction<'translation', undefined, 'translation'>) => {
    return yup.object().shape(
        {
            ...
            EA_Profil_PO_psc: yup.string().when('EA_Profil_PO_psc', {
                is: (val: string) => val !== '',
                then: () => yup.string().matches(/\b\d{5}\b/gm, t('organizations.create.postalCodeRegex')),
