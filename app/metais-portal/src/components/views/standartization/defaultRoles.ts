export const DEFAULT_ROLES = [
    { id: 1, value: 'Predseda KS ISVS', code: 'STD_KSPRE', description: 'STD_KSPRE', valid: true },
    { id: 2, value: 'Podpredseda KS ISVS', code: 'STD_KSPODP', description: 'STD_KSPODP', valid: true },
    { id: 3, value: 'Tajomník KS ISVS', code: 'STD_KSTAJ', description: 'STD_KSTAJ', valid: true },
