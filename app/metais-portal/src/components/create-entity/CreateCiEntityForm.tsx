...
export const CreateCiEntityForm: React.FC<ICreateCiEntityForm> = ({
    ...
    }, [attributes, entityName, isUpdate, state.user?.email, state.user?.firstName, state.user?.lastName, state.user?.phone, state.user?.position])
