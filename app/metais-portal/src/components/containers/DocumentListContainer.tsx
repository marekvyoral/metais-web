...
import { useReadCiNeighbours, ReadCiNeighbours200, BASE_PAGE_NUMBER, BASE_PAGE_SIZE } from '@isdd/metais-common/api'
...
export const DocumentsListContainer: React.FC<IDocumentsListContainer> = ({ configurationItemId, View }) => {
    ...
    const {
        ...
        isError,
        data: documentCiData,
    } = useReadCiNeighbours(configurationItemId ?? '', mapFilterToNeighborsApi(uiFilterState, defaultRequestApi), {})
