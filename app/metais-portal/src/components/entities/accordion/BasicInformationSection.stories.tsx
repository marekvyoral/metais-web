...
export default meta
type Story = StoryObj<typeof BasicInformationSection>

export const DefaultAttributeProfileAccordion: Story = {
    args: {
        codeMetaIS: 'isvs_11775',
        admin: (
            <TextLinkExternal title={'Ministerstvo dopravy Slovenskej republiky'} href={'#'} textLink={'Ministerstvo dopravy Slovenskej republiky'} />
        ),
