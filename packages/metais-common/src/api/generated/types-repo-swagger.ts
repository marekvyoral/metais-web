...
export const getListAttrProfileUsingPOSTQueryKey = (attributeProfileFilterBody: AttributeProfileFilterBody) =>
    [`/attrprofiles/list`, attributeProfileFilterBody] as const

export const useListAttrProfileUsingPOSTQueryOptions = <
    TData = Awaited<ReturnType<ReturnType<typeof useListAttrProfileUsingPOSTHook>>>,
    TError = unknown,
>(
    attributeProfileFilterBody: AttributeProfileFilterBody,
    options?: { query?: UseQueryOptions<Awaited<ReturnType<ReturnType<typeof useListAttrProfileUsingPOSTHook>>>, TError, TData> },
): UseQueryOptions<Awaited<ReturnType<ReturnType<typeof useListAttrProfileUsingPOSTHook>>>, TError, TData> & { queryKey: QueryKey } => {
    const { query: queryOptions } = options ?? {}

    const queryKey = queryOptions?.queryKey ?? getListAttrProfileUsingPOSTQueryKey(attributeProfileFilterBody)

    const listAttrProfileUsingPOST = useListAttrProfileUsingPOSTHook()

    const queryFn: QueryFunction<Awaited<ReturnType<ReturnType<typeof useListAttrProfileUsingPOSTHook>>>> = () =>
        listAttrProfileUsingPOST(attributeProfileFilterBody)

    return { queryKey, queryFn, ...queryOptions }
}

export type ListAttrProfileUsingPOSTQueryResult = NonNullable<Awaited<ReturnType<ReturnType<typeof useListAttrProfileUsingPOSTHook>>>>
export type ListAttrProfileUsingPOSTQueryError = unknown

/**
 * @summary listAttrProfile
 */
export const useListAttrProfileUsingPOST = <TData = Awaited<ReturnType<ReturnType<typeof useListAttrProfileUsingPOSTHook>>>, TError = unknown>(
    attributeProfileFilterBody: AttributeProfileFilterBody,
    options?: { query?: UseQueryOptions<Awaited<ReturnType<ReturnType<typeof useListAttrProfileUsingPOSTHook>>>, TError, TData> },
): UseQueryResult<TData, TError> & { queryKey: QueryKey } => {
    const queryOptions = useListAttrProfileUsingPOSTQueryOptions(attributeProfileFilterBody, options)
...
export const getListTypesUsingPOSTQueryKey = (typesFilter: TypesFilter) => [`/citypes/relationshiptypes/list`, typesFilter] as const

export const useListTypesUsingPOSTQueryOptions = <TData = Awaited<ReturnType<ReturnType<typeof useListTypesUsingPOSTHook>>>, TError = unknown>(
    typesFilter: TypesFilter,
    options?: { query?: UseQueryOptions<Awaited<ReturnType<ReturnType<typeof useListTypesUsingPOSTHook>>>, TError, TData> },
): UseQueryOptions<Awaited<ReturnType<ReturnType<typeof useListTypesUsingPOSTHook>>>, TError, TData> & { queryKey: QueryKey } => {
    const { query: queryOptions } = options ?? {}

    const queryKey = queryOptions?.queryKey ?? getListTypesUsingPOSTQueryKey(typesFilter)

    const listTypesUsingPOST = useListTypesUsingPOSTHook()

    const queryFn: QueryFunction<Awaited<ReturnType<ReturnType<typeof useListTypesUsingPOSTHook>>>> = () => listTypesUsingPOST(typesFilter)

    return { queryKey, queryFn, ...queryOptions }
}

export type ListTypesUsingPOSTQueryResult = NonNullable<Awaited<ReturnType<ReturnType<typeof useListTypesUsingPOSTHook>>>>
export type ListTypesUsingPOSTQueryError = unknown

/**
 * @summary listTypes
 */
export const useListTypesUsingPOST = <TData = Awaited<ReturnType<ReturnType<typeof useListTypesUsingPOSTHook>>>, TError = unknown>(
    typesFilter: TypesFilter,
    options?: { query?: UseQueryOptions<Awaited<ReturnType<ReturnType<typeof useListTypesUsingPOSTHook>>>, TError, TData> },
): UseQueryResult<TData, TError> & { queryKey: QueryKey } => {
    const queryOptions = useListTypesUsingPOSTQueryOptions(typesFilter, options)
