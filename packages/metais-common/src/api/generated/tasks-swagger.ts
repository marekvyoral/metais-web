...
import { BodyType } from '../hooks/use-custom-client'
...
export const useReassignTaskWithUserHook = () => {
    ...
    return (id: number, simpleTask: BodyType<SimpleTask>) => {
...
export const useReassignTaskHook = () => {
    ...
    return (simpleTask: BodyType<SimpleTask>) => {
        return reassignTask({
            url: `/tasks/reassign`,
            method: 'put',
            headers: { 'Content-Type': 'application/json;charset=UTF-8' },
...
export const useGetTasksHook = () => {
    ...
    return (taskRequest: BodyType<TaskRequest>) => {
