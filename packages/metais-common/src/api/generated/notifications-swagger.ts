...
export const useReindexQueryOptions = <TData = Awaited<ReturnType<ReturnType<typeof useReindexHook>>>, TError = ApiError>(options?: {
...
export const useReindex = <TData = Awaited<ReturnType<ReturnType<typeof useReindexHook>>>, TError = ApiError>(options?: {
    query?: UseQueryOptions<Awaited<ReturnType<ReturnType<typeof useReindexHook>>>, TError, TData>
}): UseQueryResult<TData, TError> & { queryKey: QueryKey } => {
